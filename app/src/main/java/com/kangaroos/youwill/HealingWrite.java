...
public class HealingWrite extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEditor = findViewById(R.id.editor_healing_write);
        ...
        button_submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                databaseReference.child("Healing").child(id).setValue(new HealingItem(editText_title.getText().toString(), content, date, hm, 0, id, uid));
